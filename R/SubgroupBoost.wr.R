...
#' @param comparison The types of outcome to compare in win-ratio based value function. The possible choices are
#' \itemize{
...
#' @export SubgroupBoost.wr
#' @import xgboost
#'
#' @examples NULL
SubgroupBoost.wr <- function(dat, info, comparison){
  ...
  if(1){
    ...
    for(i in 1:nrow(hyper_grid)) {
      ...
      params <- list(
        objective = Myloss.train,
        eval_metric = evalerror.test,
